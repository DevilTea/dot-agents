...
目前只有 3 個 global skills：`agent-browser`、`commit`、`maintain-skill`。Setup 只逐一安裝此目錄的內容，不會安裝 [`../optional-skills/`](../optional-skills/)，也不會因 canonical source 少了一個 entry 就自動刪除目的地內容。
